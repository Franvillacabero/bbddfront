...
export default {
  setup() {
    ...
    // Método para desencriptar las contraseñas de los registros
      ...
      try {
        const registrosConPasswordDesencriptado = await Promise.all(
          registrosEncriptados.map(async (registro) => {
            ...
            // Ya no usamos aesHelper, la desencriptación será desde el backend
                ...
                >
                  ...
                  <td class="column-password">
                    <div class="password-cell">
                      <!-- Mostrar contraseña desencriptada o encriptada según el estado -->
                      ...
                      <div class="password-actions">
                        ...
                        <button
                          @click="
                            togglePasswordVisibility(registro.id_Registro)
                          "
